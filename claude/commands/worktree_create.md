...
Create a new git worktree to enable parallel AI coding workflows. This allows multiple Claude Code instances to work on different features simultaneously without context switching or merge conflicts.
...
- Perfect for running multiple Claude Code instances in parallel
...
The new Claude Code instance will have full context and won't interfere with work in this directory.
...
- Each worktree requires a new Claude Code instance (new terminal session)
- The current Claude Code session should stay in the main project directory
