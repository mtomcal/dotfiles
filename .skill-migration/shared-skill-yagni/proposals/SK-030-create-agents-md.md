...
7. Compare `TEMPLATE.md`, `PRINCIPLES_CATALOG.md`, and `scripts/detect-structure.sh` byte-for-byte and modes against baseline. Require detector mode `100775`.
