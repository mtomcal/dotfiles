...
| `VG-001` | verification | Entire shared catalog | links, commands, support, provenance, behavior ledgers, frontmatter, visibility | MG-002, SK-001–SK-033, NEW-001 | verified |
...
`MG-001` revision 2, `MG-002` revision 1, SK-001 through SK-033, NEW-001, and VG-001 are verified. The migration ledger is complete and no frontier remains. VG-001 records SK-027's unchanged command-grant warning as a separate frontmatter-lane follow-up and retains NEW-001's intentional Pi-visibility exclusion as a separately authorized discoverability decision.
