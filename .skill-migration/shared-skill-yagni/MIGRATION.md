...
| `SK-025` | skill | `tdd` | simplify inline | SK-001, SK-013 | integrating |
...
`MG-001` revision 2, `MG-002` revision 1, and SK-001 through SK-024 are verified. SK-025 and SK-026 are claimed with disjoint scopes. The remaining verified-blocker frontier contains SK-027, SK-028, SK-029, SK-030, SK-031, SK-032, and NEW-001. No queued production file is authorized until claimed with an item-specific exact proposal in `proposal-ready` state.
