...
| `SK-012` | skill | `audit-shared-skills` | simplify inline; remove unused Info severity | SK-001 | integrating |
...
`MG-001` revision 2, `MG-002` revision 1, SK-001 through SK-011 are verified. SK-012 is integrating. No later production file is authorized without its item-specific exact proposal in `proposal-ready` state.
