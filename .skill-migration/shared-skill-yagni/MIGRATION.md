...
| `SK-027` | skill | `visual-qa` | simplify inline | SK-001, SK-005, SK-021, SK-026 | integrating |
...
| `NEW-001` | new skill | Generic Git delivery | independently invocable PR/CI/stale-branch owner | SK-001, SK-014, SK-024 | claimed |
...
`MG-001` revision 2, `MG-002` revision 1, and SK-001 through SK-026 are verified. SK-027 and NEW-001 are claimed with disjoint scopes. The remaining verified-blocker frontier contains SK-028, SK-029, SK-030, SK-031, and SK-032. No queued production file is authorized until claimed with an item-specific exact proposal in `proposal-ready` state.
