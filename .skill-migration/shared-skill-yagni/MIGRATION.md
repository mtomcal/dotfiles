...
`MG-001` revision 2, `MG-002` revision 1, and SK-001 through SK-012 are verified. The next verified-blocker frontier begins with SK-013 and SK-014; both are unblocked and their direct targets are disjoint. No later production file is authorized without its item-specific exact proposal in `proposal-ready` state.
