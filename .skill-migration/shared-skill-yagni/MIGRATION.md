...
| `SK-017` | skill | `design-md` | simplify inline | SK-001 | integrating |
...
`MG-001` revision 2, `MG-002` revision 1, and SK-001 through SK-016 are verified. SK-017 is integrating and SK-019 remains claimed; SK-018 is verified. No later production file is authorized without its item-specific exact proposal in `proposal-ready` state.
