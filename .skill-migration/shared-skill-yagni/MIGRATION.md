...
| `SK-020` | skill | `image-comparison-judge` | simplify inline | SK-001 | integrating |
| `SK-021` | skill | `image-diff-describer` | retain substance | SK-001 | claimed |
...
`MG-001` revision 2, `MG-002` revision 1, and SK-001 through SK-019 are verified. SK-020 and SK-021 are claimed with disjoint scopes. The remaining verified-blocker frontier contains SK-022, SK-023, SK-024, SK-025, SK-026, SK-028, SK-030, SK-031, and SK-032; no queued production file is authorized until claimed with an item-specific exact proposal in `proposal-ready` state.
