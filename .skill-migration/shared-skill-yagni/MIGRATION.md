...
| `SK-017` | skill | `design-md` | simplify inline | SK-001 | claimed |
...
`MG-001` revision 2, `MG-002` revision 1, and SK-001 through SK-016 are verified. SK-017 and SK-019 are claimed; SK-018 is verified. No later production file is authorized without its item-specific exact proposal in `proposal-ready` state.
