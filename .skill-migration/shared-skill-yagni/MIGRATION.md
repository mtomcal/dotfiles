...
| `SK-018` | skill | `grill-me` | retain substance | SK-001, MG-002 | integrating |
...
`MG-001` revision 2, `MG-002` revision 1, and SK-001 through SK-016 are verified. SK-017 remains claimed and SK-018 is integrating; their scopes are disjoint. No later production file is authorized without its item-specific exact proposal in `proposal-ready` state.
