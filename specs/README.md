...
|------|-------------|---------|
| [parameters.md](parameters.md) | All tuning values with rationale | 3.0.0 |
...
| [herdr-config.md](herdr-config.md) | Herdr default multiplexer and migration contract | 1.0.0 |
...
| [execution-coordination.md](execution-coordination.md) | Beads command-repo execution and recovery contract | 2.0.0 |
| [skill-library.md](skill-library.md) | Shared-skill catalog and authoring contracts | 9.0.0 |
...
- [ ] Complete runtime validation of execution-coordination — bootstrap/routing, atomic creation, correction-return recovery, compact projection write/readback mechanics, and Watchdog removal have been exercised with Firepod; current projection reconciliation was deferred after concurrent molecule progress, and end-to-end summary-first recovery, slice integration, final reviews, and completion remain to validate
...
| Version | Date | Change |
|---------|------|--------|
| 0.21.0 | 2026-08-03 | Registered solo coordinator execution, compact recovery projections, summary-first startup, complete Watchdog unshipping, migration behavior, and affected breaking spec versions. |
