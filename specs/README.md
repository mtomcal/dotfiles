...
| [ai-agent-config.md](ai-agent-config.md) | AI agent runtime configs and catalog exposure | 3.2.0 |
...
| Version | Date | Change |
|---------|------|--------|
| 0.11.0 | 2026-08-01 | Registered Execution Coordination, Beads/Dolt tooling, command-repo shell routing, updated dependency order, and current spec versions. |
