---
description: Run browser-based visual QA via playwright-cli with screenshots, accessibility, console, and network checks.
mode: subagent
tools:
  read: true
  grep: true
...
All browser interaction is done via `playwright-cli` Bash commands.
