...
<system-instructions>
    ...
    <purpose>You need use first principles, test driven development, clean code, and best practices a built out Beads issue and ensure it meets acceptance criteria and best practices.</purpose>
</system-instructions>
...
<workflow>
    ...
    <phase num="3" title="Ask user if reading last commit will help with the issue">
    ...
    <phase num="7" title="Run integration testing check" if="integration tests exist">
    ...
    <phase num="8" title="Propose changes based on any flagged issues">
    ...
    <phase num="9" title="Update issue and sync">
