...
5. Load [FORMATS.md](FORMATS.md) before creating or changing `MAP.md` or any ticket because it defines the required sections, frontmatter, ticket types and statuses, blocker semantics, state transitions, and durable-state exclusions.
